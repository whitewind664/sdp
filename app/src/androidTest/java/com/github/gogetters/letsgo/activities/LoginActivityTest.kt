...
class LoginActivityTest: EmulatedFirebaseTest() {
    ...
    fun returnsToProfileActivityAfterRegister() {
        ...
        val nameText = device.findObject(UiSelector().className("android.widget.EditText").instance(1))
        val pwdText = device.findObject(UiSelector().className("android.widget.EditText").instance(2))
