...
internal class TutorialGame(private val localPlayer: TutorialLocalPlayer, private val tutorialPlayer: TutorialPlayer): Game(Board.Size.SMALL, 0.0, tutorialPlayer, localPlayer) {
    ...
    init {
        ...
        tutorialSteps += TutorialStep(9, true, true, listOf(Move(Stone.BLACK, Point(2, 1)), Move(Stone.WHITE, Point(3, 1)), Move(Stone.BLACK, Point(2, 2)), Move(Stone.WHITE, Point(3, 2)), Move(Stone.BLACK, Point(2, 3)), Move(Stone.WHITE, Point(3, 3)), Move(Stone.BLACK, Point(1, 2)), Move(Stone.WHITE, Point(2, 4)), Move(Stone.BLACK, Point(1, 3)), Move(Stone.WHITE, Point(1, 4))), emptyList(), listOf(Point(1, 1))) // self capturing
        tutorialSteps += TutorialStep(10, true, true, listOf(Move(Stone.BLACK, Point(2, 1)), Move(Stone.WHITE, Point(4, 1)), Move(Stone.BLACK, Point(2, 2)), Move(Stone.WHITE, Point(4, 2)), Move(Stone.BLACK, Point(2, 4)), Move(Stone.WHITE, Point(4, 3)), Move(Stone.BLACK, Point(1, 2)), Move(Stone.WHITE, Point(3, 5)), Move(Stone.BLACK, Point(1, 3)), Move(Stone.WHITE, Point(2, 5)), Move(Stone.BLACK, Point(1, 4)), Move(Stone.WHITE, Point(5, 4)), Move(Stone.BLACK, Point(3, 1)), Move(Stone.WHITE, Point(6, 3)), Move(Stone.BLACK, Point(3, 2)), Move(Stone.WHITE, Point(6, 2)), Move(Stone.BLACK, Point(3, 3)), Move(Stone.WHITE, Point(4, 4)), Move(Stone.BLACK, Point(3, 4)), Move(Stone.WHITE, Point(1, 5))), emptyList(), emptyList()) // two eyes
        tutorialSteps += TutorialStep(13, true, true, listOf(Move(Stone.BLACK, Point(5, 4)), Move(Stone.WHITE, Point(4, 4)), Move(Stone.BLACK, Point(6, 5)), Move(Stone.WHITE, Point(3, 5)), Move(Stone.BLACK, Point(5, 6)), Move(Stone.WHITE, Point(4, 6)), Move(Stone.BLACK, Point(6, 4)), Move(Stone.WHITE, Point(5, 5))), listOf(listOf(Move(Stone.BLACK, Point(4, 5)))), emptyList()) // Ko Rule
    }
